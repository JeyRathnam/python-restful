...
from Views import Account,Test,UserGames,GameSession
...
api.add_resource(UserGames.getUserGames, '/getUserGame')
api.add_resource(GameSession.CreateSession, '/createGameSession')
